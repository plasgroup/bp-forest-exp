...
mkdir -p build
echo Size_per_DPU,WRAM_or_MRAM,NR_DPUS,push_transfer,push_transfer_1DPUin4,push_transfer_serial,broadcast | tee ./data/preliminary/transfer_performance.csv
